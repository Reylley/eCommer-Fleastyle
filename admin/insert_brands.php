...
<form action="" method="post" class="mb-2">
    ...
    <input type="text" class="form-control" name="brand_title" placeholder="Brand title"
     aria-label="brand_title" aria-describedby="basic-addon1" autocomplete="off">
    </div>
    <div class="input-group w-10 mb-2 text-center">
    <!-- <input type="submit" class="form-control" name="insert_cat" value="Insert Categories"> -->
    <input  type="submit" class="bg-info border-0 rounded-3 p-2 my-3 ms-auto" name="insert_brand" value="Insert Brand">
    <!-- <button type="submit" class="bg-info border-0 rounded-3 p-2 m-3" name="insert_cat">Insert Brands</button> -->
    </div>
</form>